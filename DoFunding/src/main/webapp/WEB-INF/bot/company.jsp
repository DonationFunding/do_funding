...
<div class="text2">
Do funding
Do funding은 더 나은 사회를 꿈꾸는 다양한 공익 프로젝트가 진행되는 온라인 기부 펀딩 사이트 입니다. 
2022년 4월 서비스를 시작한 이후, 다양한 방식의 기부와 후원이 이루어지고 있습니다. 
공익단체는 Do Funding을 통해 프로젝트를 홍보하고 모금을 진행할 수 있으며, Do Funding 가입자라면 누구나 Do Funding의 공익 프로젝트를 응원할 수 있습니다.
가입자가 펀딩을 하면 펀딩 금액을 Do Funding이 기부합니다. 사회 문제를 해결하고자 하는 공익단체, 소셜벤처, 개인의 프로젝트를 '펀딩'서비스를 통해 소개합니다.
