...
public class DetailViewController {
	...
	public String doAction(
			...
			Model model) {
			//주문 상세 보기 
			List<ShoppingInfo> detailList=compositeDao.detailList(oid);
			for(ShoppingInfo sh:detailList) {
				System.out.println("controll:"+sh.getPnum());
				System.out.println("controll:"+sh.getPname());
			}
